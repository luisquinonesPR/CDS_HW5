...
def retrieve_age_eafp(dict):
    ...
    year = today.year
    try:
        birthyear = dict['birth']
        age = year - birthyear
        return age
    except KeyError:
        return "Oh dear! Looks like you didn't provide that information!"

retrieve_age_eafp(my_dict2)
...
def retrieve_age_lbyl(dict):
    ...
    year = today.year
    if 'birth' in dict:
        birthyear = dict.get('birth', None)
        age = year - birthyear
        return age
    else:
        return "Oh dear! Looks like you didn't provide that information!"

retrieve_age_lbyl(my_dict2)
...
def read_data(file):
    try:
        ...
        return "I don't think this file exists..."
